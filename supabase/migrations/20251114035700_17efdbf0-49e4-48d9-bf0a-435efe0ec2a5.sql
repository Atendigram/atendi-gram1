...
DROP POLICY IF EXISTS "contatos_geral_by_profile_account_select" ON public.contatos_geral;
...
DROP POLICY IF EXISTS "contatos_geral_insert_policy" ON public.contatos_geral;
DROP POLICY IF EXISTS "Members can insert account contatos_luna" ON public.contatos_geral;
DROP POLICY IF EXISTS "contatos_geral_update_policy" ON public.contatos_geral;
DROP POLICY IF EXISTS "Members can update account contatos_luna" ON public.contatos_geral;
DROP POLICY IF EXISTS "contatos_geral_delete_policy" ON public.contatos_geral;
...
DROP POLICY IF EXISTS "disparos_select_policy" ON public.disparos;
...
DROP POLICY IF EXISTS "disparos_insert_policy" ON public.disparos;
...
DROP POLICY IF EXISTS "disparos_update_policy" ON public.disparos;
...
DROP POLICY IF EXISTS "disparos_delete_policy" ON public.disparos;
...
DROP POLICY IF EXISTS "disparo_items_select_policy" ON public.disparo_items;
...
DROP POLICY IF EXISTS "disparo_items_insert_policy" ON public.disparo_items;
...
DROP POLICY IF EXISTS "disparo_items_update_policy" ON public.disparo_items;
...
DROP POLICY IF EXISTS "disparo_items_delete_policy" ON public.disparo_items;
...
DROP POLICY IF EXISTS "welcome_flows_select_policy" ON public.welcome_flows;
DROP POLICY IF EXISTS "Members can view account welcome_flows" ON public.welcome_flows;
DROP POLICY IF EXISTS "welcome_flows_insert_policy" ON public.welcome_flows;
DROP POLICY IF EXISTS "Members can insert account welcome_flows" ON public.welcome_flows;
DROP POLICY IF EXISTS "welcome_flows_update_policy" ON public.welcome_flows;
DROP POLICY IF EXISTS "Members can update account welcome_flows" ON public.welcome_flows;
DROP POLICY IF EXISTS "welcome_flows_delete_policy" ON public.welcome_flows;
...
DROP POLICY IF EXISTS "welcome_flow_steps_select_policy" ON public.welcome_flow_steps;
DROP POLICY IF EXISTS "Members can view account welcome_flow_steps" ON public.welcome_flow_steps;
DROP POLICY IF EXISTS "welcome_flow_steps_insert_policy" ON public.welcome_flow_steps;
DROP POLICY IF EXISTS "Members can insert account welcome_flow_steps" ON public.welcome_flow_steps;
DROP POLICY IF EXISTS "welcome_flow_steps_update_policy" ON public.welcome_flow_steps;
DROP POLICY IF EXISTS "Members can update account welcome_flow_steps" ON public.welcome_flow_steps;
DROP POLICY IF EXISTS "welcome_flow_steps_delete_policy" ON public.welcome_flow_steps;
...
DROP POLICY IF EXISTS "boas_vindas_settings_select_policy" ON public.boas_vindas_settings;
DROP POLICY IF EXISTS "Members can view account boas_vindas_settings" ON public.boas_vindas_settings;
DROP POLICY IF EXISTS "boas_vindas_settings_insert_policy" ON public.boas_vindas_settings;
DROP POLICY IF EXISTS "Members can insert account boas_vindas_settings" ON public.boas_vindas_settings;
DROP POLICY IF EXISTS "boas_vindas_settings_update_policy" ON public.boas_vindas_settings;
DROP POLICY IF EXISTS "Members can update account boas_vindas_settings" ON public.boas_vindas_settings;
DROP POLICY IF EXISTS "boas_vindas_settings_delete_policy" ON public.boas_vindas_settings;
...
DROP POLICY IF EXISTS "logsluna_select_policy" ON public.logsluna;
DROP POLICY IF EXISTS "Members can view account logsluna" ON public.logsluna;
DROP POLICY IF EXISTS "logsluna_insert_policy" ON public.logsluna;
DROP POLICY IF EXISTS "Members can insert account logsluna" ON public.logsluna;
DROP POLICY IF EXISTS "logsluna_update_policy" ON public.logsluna;
DROP POLICY IF EXISTS "Members can update account logsluna" ON public.logsluna;
DROP POLICY IF EXISTS "logsluna_delete_policy" ON public.logsluna;
