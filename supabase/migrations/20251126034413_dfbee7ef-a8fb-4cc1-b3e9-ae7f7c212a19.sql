-- Consolidar triggers de criação de conta para evitar duplicação
-- Remove trigger antigo e garante que setup_new_account faça tudo

-- 1. Remove o trigger antigo que só copiava o welcome flow
DROP TRIGGER IF EXISTS after_account_insert ON public.accounts;

-- 2. Garantir que setup_new_account está correta e completa
